...
{	
	int width, height;
	int win_score = 50; //you can change it to any value
		...
		while (snake_lose == false && COM_lose == false && COM_score != win_score && snake_score != win_score)
		{
			...
			cout << "player score: " << snake_score << endl;
			cout << "COM score: " << COM_score;
		}
		
		Sleep(2000);
		system("cls");
		cout << "player score: " << snake_score << "\n";
		cout << "COM score: " << COM_score << "\n\n\n\n";
		if (snake_lose || COM_score == win_score) cout << "COMPUTER WINS, HARD LUCK" << endl;
		else if(COM_lose || snake_score == win_score) cout << "YOU WIN, CONGRATULATIONS";
